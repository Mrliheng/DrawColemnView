...
- (void)drawRect:(CGRect)rect
{
    ...
    [self drawVerticalLinesWithContext:ctx];//绘制竖线
    
    [self drawHorizontalLinesWithContext:ctx];//绘制横线
    
    [self drawBarsWithContext:ctx];//绘制柱形
    
    
}

- (void)drawVerticalLinesWithContext:(CGContextRef)ctx
{
